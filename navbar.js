let navbar= ()=>{
    ...
    <div id="menu">
        <div class="dropdown" id="dd">
            ...
            <div class="dropdown-content" id="supports">
                <p>Supports:<br/>Preferred Partners     </p> <p> <a href="">Stripe</a><a href="">Paypal</a><a href="">Braintree</a><a
                    href="">Checkout.com</a><a href="">GoCardless</a> and <a href=""> 27 other payment gateways.</a> </p> <p>Seamless integration with <a href="">Xero</a> <a href="">QuickBooks</a> <a href="">Zendesk</a> <a href="">Salesforce</a> + 18 more.</p>
                    <p><a href="">Explore all features ></a></p>
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content" id="resources">
                ...
                <a href="#">Chargebee's in-house team of implementation experts is here to make sure you go live
                    with your Chargebee site at lightning-fast speed.
                    <p>Professional Services & Implementation ></p>
                </a>
                <a href="#">Learn to unlock all revenue secrets to secure hyper-growth for your business. Access
                    free certifications, courses, and expert masterclasses.
                    <p>Subscription Academy ></p>
                </a>
                <a href="#">Explore the best practices of all things SaaS and Subscription Billing.
                    <p>Webinars ></p>
                </a>
                <a href="#">Learn about the possibilities that change brings about and how Chargebee recognizes
                    & celebrates change-makers by being an enabler of change.
